...
export default function VillaEkleModal({ kapat, villaEklendi }) {
  ...
  async function handleSubmit(e) {
    ...
    if (dosyalar.length === 0) {
      setHata("Lütfen en az bir görsel yükleyin.");
      return;
    }
    ...
    try {
      ...
      // Görselleri yükle
      const gorselURLleri = await Promise.all(
      ...
      // Firestore'a villa bilgilerini ekle
      const villaVerisi = {
        ...formVeri,
      ...
      delete villaVerisi.fiyatlar;
      
      const yeniVillaRef = await addDoc(collection(db, "villalar"), villaVerisi);
      
      // Yeni villa bilgilerini ana sayfaya gönder
      villaEklendi({
        id: yeniVillaRef.id,
        ...villaVerisi
      });
      ...
      setHata("Villa eklenirken bir hata oluştu. Lütfen daha sonra tekrar deneyin.");
    } finally {
      setYukleniyor(false);
    }
  }
      ...
      <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-white/5 rounded-t-2xl sm:rounded-2xl shadow-2xl max-w-3xl w-full max-h-[95vh] sm:max-h-[90vh] overflow-y-auto animate-slide-up sm:animate-fade-in">
        <div className="bg-neutral-50 dark:bg-neutral-950/40 border-b border-neutral-200 dark:border-white/5 px-6 py-4 text-neutral-900 dark:text-white">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-bold">Yeni Villa Ekle</h2>
            <button
              onClick={kapat}
              className="text-neutral-400 dark:text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white rounded-full p-2 transition-colors duration-300"
            >
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="border-b border-neutral-200 dark:border-white/5 pb-6">
              <h3 className="text-sm font-bold text-neutral-900 dark:text-white uppercase tracking-wider mb-4">Temel Bilgiler</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="col-span-full">
                  <label htmlFor="ad" className="block text-xs font-semibold uppercase tracking-wider text-neutral-400 dark:text-neutral-500 dark:text-neutral-400 mb-1.5">
                    Villa Adı <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="text"
                    id="ad"
                ...
                <div className="col-span-full">
                  <label htmlFor="belgeNo" className="block text-xs font-semibold uppercase tracking-wider text-neutral-400 dark:text-neutral-500 dark:text-neutral-400 mb-1.5">
                ...
                <div>
                  <label htmlFor="kapasite" className="block text-xs font-semibold uppercase tracking-wider text-neutral-400 dark:text-neutral-500 dark:text-neutral-400 mb-1.5">
                    Kapasite (Kişi Sayısı) <span className="text-red-500">*</span>
                  </label>
                ...
                <div>
                  <label htmlFor="denizeUzaklik" className="block text-xs font-semibold uppercase tracking-wider text-neutral-400 dark:text-neutral-500 dark:text-neutral-400 mb-1.5">
                    Denize Uzaklık
                  </label>
                  <div className="relative flex items-center">
                    ...
                    <div className="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                      <span className="text-sm font-medium text-neutral-400 dark:text-neutral-500">km</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-span-full grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="il" className="block text-xs font-semibold uppercase tracking-wider text-neutral-400 dark:text-neutral-500 dark:text-neutral-400 mb-1.5">
                  ...
                  <div>
                    <label htmlFor="ilce" className="block text-xs font-semibold uppercase tracking-wider text-neutral-400 dark:text-neutral-500 dark:text-neutral-400 mb-1.5">
                ...
                <div className="col-span-full">
                  <label htmlFor="aciklama" className="block text-xs font-semibold uppercase tracking-wider text-neutral-400 dark:text-neutral-500 dark:text-neutral-400 mb-1.5">
                ...
                <div className="col-span-full border-t border-neutral-200 dark:border-white/5 pt-6 mt-2">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                      <label htmlFor="roomCount" className="block text-[10px] font-bold text-neutral-400 dark:text-neutral-500 dark:text-neutral-400 uppercase tracking-wider mb-1">
                        Oda Sayısı
                      </label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label htmlFor="balconyCount" className="block text-[10px] font-bold text-neutral-400 dark:text-neutral-500 dark:text-neutral-400 uppercase tracking-wider mb-1">
                        Balkon Sayısı
                      </label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label htmlFor="showerCount" className="block text-[10px] font-bold text-neutral-400 dark:text-neutral-500 dark:text-neutral-400 uppercase tracking-wider mb-1">
                        Duş Sayısı
                      </label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label htmlFor="toiletCount" className="block text-[10px] font-bold text-neutral-400 dark:text-neutral-500 dark:text-neutral-400 uppercase tracking-wider mb-1">
                        Lavabo Sayısı
                      </label>
                      <input
                        type="number"
                ...
                <div className="col-span-full border-t border-neutral-200 dark:border-white/5 pt-6 mt-2">
                  <label htmlFor="mapEmbedUrl" className="block text-xs font-semibold uppercase tracking-wider text-neutral-400 dark:text-neutral-500 dark:text-neutral-400 mb-1.5">
            ...
            <div className="border-b border-neutral-200 dark:border-white/5 pb-6">
              ...
              <p className="text-xs text-neutral-400 dark:text-neutral-500 mb-4">Villanın sahip olduğu lüks ve konsept özellikleri seçin.</p>
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-3 p-3 rounded-xl border text-left transition-all duration-200 ${
                        isChecked
                          ? "border-primary-500/40 bg-primary-500/10 text-primary-200 shadow-sm"
            ...
            <div>
              <label className="block text-xs font-semibold uppercase tracking-wider text-neutral-400 dark:text-neutral-500 dark:text-neutral-400 mb-2">
                Görseller <span className="text-red-500">*</span>
              </label>
              <div className="border-2 border-dashed border-neutral-200 dark:border-white/5 rounded-xl p-6 text-center hover:border-primary-500/40 transition-colors cursor-pointer bg-neutral-50 dark:bg-neutral-950/20">
                <input
                  type="file"
                  ...
                  id="villa-gorselleri"
                />
                <label htmlFor="villa-gorselleri" className="cursor-pointer">
                  <svg className="mx-auto h-12 w-12 text-neutral-500 dark:text-neutral-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                  <p className="mt-2 text-xs text-neutral-400 dark:text-neutral-500 dark:text-neutral-400">
                    <span className="font-semibold text-primary-400">Dosya seçmek için tıklayın</span> veya dosyaları sürükleyin
                  </p>
            ...
            {dosyalar.length > 0 && (
              <div>
                <h3 className="text-xs font-bold text-neutral-900 dark:text-white uppercase tracking-wider mb-3">Görsel Önizlemeleri ({dosyalar.length})</h3>
            ...
            <div className="flex justify-end space-x-3 pt-4 border-t border-neutral-200 dark:border-white/5">
              <button
                type="button"
                onClick={kapat}
                className="px-4 py-2.5 bg-white dark:bg-neutral-950 hover:bg-neutral-50 dark:hover:bg-neutral-800 text-neutral-700 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-white border border-neutral-200 dark:border-white/5 rounded-xl text-xs font-semibold transition-all"
                disabled={yukleniyor}
              >
                İptal
              </button>
